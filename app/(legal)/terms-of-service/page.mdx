...
All content provided through DeepSeek OCR, including but not limited to templates, code, infrastructure setup, and documentation, is protected under copyright law. The copyright owner of DeepSeek OCR is **shipany.ai**.

- You acknowledge that you do not own the underlying technology or intellectual property that makes up the DeepSeek OCR service, and you agree to respect the intellectual property rights of shipany.ai and any third parties.
- While you retain ownership of your custom implementations and modifications, the core DeepSeek OCR platform and templates remain the property of shipany.ai.
